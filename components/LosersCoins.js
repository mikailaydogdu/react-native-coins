...
const LosersCoins = ({ screenName, screenHome, screenExpired }) => {
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.body}>
          <Text style={[styles.headertitle, {color:"red"}]}>Top Losers</Text>
          <Text style={[styles.a, {backgroundColor:"red"}]}></Text>
          <Text style={[styles.headertitleRight]}>see all</Text>
          ...
          <FlatList
            ...
            data={data.sort(function(a,b){return a.price_change_percentage_24h-b.price_change_percentage_24h}).slice(0,5)}
